...
in {
  options.myThemes = {
    ...
    autoSwitch = {
      ...
      dayTheme = lib.mkOption { type = lib.types.str; default = "everforest-dark"; description = "Theme label used during day hours."; };
      nightTheme = lib.mkOption { type = lib.types.str; default = "everforest-dark"; description = "Theme label used during night hours."; };
      dayStart = lib.mkOption { type = lib.types.int; default = 7; description = "Hour (0-23) when day theme becomes active."; };
      nightStart = lib.mkOption { type = lib.types.int; default = 19; description = "Hour (0-23) when night theme becomes active."; };
    };
  };
